...
static BOOL res_regist_hotkey_1; //проверка регистрации 1-ой горячей клавиши
static BOOL res_regist_hotkey_2; //проверка регистрации 2-ой горячей клавиши
static UINT MESSAGE;        // сообщение о перерисовке окон при клике
static UINT MESSAGE_HOTKEY; //сообщение о перерегистрации горячих клавиш окна при закрытии одного из окон
